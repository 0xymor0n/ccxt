...
class ImplicitAPI:
    ...
    sapi_get_asset_assetdistributionhistory = sapiGetAssetAssetDistributionHistory = Entry('asset/assetDistributionHistory', 'sapi', 'GET', {'cost': 1})
    sapi_get_asset_query_trading_fee = sapiGetAssetQueryTradingFee = Entry('asset/query/trading-fee', 'sapi', 'GET', {'cost': 1})
    sapi_get_asset_query_trading_volume = sapiGetAssetQueryTradingVolume = Entry('asset/query/trading-volume', 'sapi', 'GET', {'cost': 1})
    sapi_get_otc_coinpairs = sapiGetOtcCoinPairs = Entry('otc/coinPairs', 'sapi', 'GET', {'cost': 1})
    sapi_get_otc_orders_orderid = sapiGetOtcOrdersOrderId = Entry('otc/orders/{orderId}', 'sapi', 'GET', {'cost': 1})
    sapi_get_otc_orders = sapiGetOtcOrders = Entry('otc/orders', 'sapi', 'GET', {'cost': 1})
    sapi_get_ocbs_orders = sapiGetOcbsOrders = Entry('ocbs/orders', 'sapi', 'GET', {'cost': 1})
    sapi_get_fiatpayment_query_withdraw_history = sapiGetFiatpaymentQueryWithdrawHistory = Entry('fiatpayment/query/withdraw/history', 'sapi', 'GET', {'cost': 1})
    sapi_get_fiatpayment_query_deposit_history = sapiGetFiatpaymentQueryDepositHistory = Entry('fiatpayment/query/deposit/history', 'sapi', 'GET', {'cost': 1})
    sapi_get_capital_sub_account_deposit_address = sapiGetCapitalSubAccountDepositAddress = Entry('capital/sub-account/deposit/address', 'sapi', 'GET', {'cost': 1})
    sapi_get_capital_sub_account_deposit_history = sapiGetCapitalSubAccountDepositHistory = Entry('capital/sub-account/deposit/history', 'sapi', 'GET', {'cost': 1})
    sapi_get_asset_query_dust_logs = sapiGetAssetQueryDustLogs = Entry('asset/query/dust-logs', 'sapi', 'GET', {'cost': 1})
    sapi_get_asset_query_dust_assets = sapiGetAssetQueryDustAssets = Entry('asset/query/dust-assets', 'sapi', 'GET', {'cost': 1})
    sapi_get_marketing_referral_reward_history = sapiGetMarketingReferralRewardHistory = Entry('marketing/referral/reward/history', 'sapi', 'GET', {'cost': 1})
    sapi_get_staking_asset = sapiGetStakingAsset = Entry('staking/asset', 'sapi', 'GET', {'cost': 1})
    sapi_get_staking_stakingbalance = sapiGetStakingStakingBalance = Entry('staking/stakingBalance', 'sapi', 'GET', {'cost': 1})
    sapi_get_staking_history = sapiGetStakingHistory = Entry('staking/history', 'sapi', 'GET', {'cost': 1})
    sapi_get_staking_stakingrewardshistory = sapiGetStakingStakingRewardsHistory = Entry('staking/stakingRewardsHistory', 'sapi', 'GET', {'cost': 1})
    sapi_get_custodian_balance = sapiGetCustodianBalance = Entry('custodian/balance', 'sapi', 'GET', {'cost': 1})
    sapi_get_custodian_supportedassetlist = sapiGetCustodianSupportedAssetList = Entry('custodian/supportedAssetList', 'sapi', 'GET', {'cost': 1})
    sapi_get_custodian_wallettransferhistory = sapiGetCustodianWalletTransferHistory = Entry('custodian/walletTransferHistory', 'sapi', 'GET', {'cost': 1})
    sapi_get_custodian_custodiantransferhistory = sapiGetCustodianCustodianTransferHistory = Entry('custodian/custodianTransferHistory', 'sapi', 'GET', {'cost': 1})
    sapi_get_custodian_openorders = sapiGetCustodianOpenOrders = Entry('custodian/openOrders', 'sapi', 'GET', {'cost': 1})
    sapi_get_custodian_order = sapiGetCustodianOrder = Entry('custodian/order', 'sapi', 'GET', {'cost': 1})
    sapi_get_custodian_orderhistory = sapiGetCustodianOrderHistory = Entry('custodian/orderHistory', 'sapi', 'GET', {'cost': 1})
    sapi_get_custodian_tradehistory = sapiGetCustodianTradeHistory = Entry('custodian/tradeHistory', 'sapi', 'GET', {'cost': 1})
    sapi_get_custodian_settlementsetting = sapiGetCustodianSettlementSetting = Entry('custodian/settlementSetting', 'sapi', 'GET', {'cost': 1})
    sapi_get_custodian_settlementhistory = sapiGetCustodianSettlementHistory = Entry('custodian/settlementHistory', 'sapi', 'GET', {'cost': 1})
    ...
    sapi_post_otc_orders = sapiPostOtcOrders = Entry('otc/orders', 'sapi', 'POST', {'cost': 1})
    sapi_post_fiatpayment_withdraw_apply = sapiPostFiatpaymentWithdrawApply = Entry('fiatpayment/withdraw/apply', 'sapi', 'POST', {'cost': 1})
    sapi_post_staking_stake = sapiPostStakingStake = Entry('staking/stake', 'sapi', 'POST', {'cost': 1})
    sapi_post_staking_unstake = sapiPostStakingUnstake = Entry('staking/unstake', 'sapi', 'POST', {'cost': 1})
    sapi_post_custodian_wallettransfer = sapiPostCustodianWalletTransfer = Entry('custodian/walletTransfer', 'sapi', 'POST', {'cost': 1})
    sapi_post_custodian_custodiantransfer = sapiPostCustodianCustodianTransfer = Entry('custodian/custodianTransfer', 'sapi', 'POST', {'cost': 1})
    sapi_post_custodian_undotransfer = sapiPostCustodianUndoTransfer = Entry('custodian/undoTransfer', 'sapi', 'POST', {'cost': 1})
    sapi_post_custodian_order = sapiPostCustodianOrder = Entry('custodian/order', 'sapi', 'POST', {'cost': 1})
    sapi_post_custodian_ocoorder = sapiPostCustodianOcoOrder = Entry('custodian/ocoOrder', 'sapi', 'POST', {'cost': 1})
    sapi_post_cl_transfer = sapiPostClTransfer = Entry('cl/transfer', 'sapi', 'POST', {'cost': 1})
    ...
    sapiv3_get_sub_account_transfer_history = sapiV3GetSubAccountTransferHistory = Entry('sub-account/transfer/history', 'sapiV3', 'GET', {'cost': 1})
    sapiv3_post_asset_getuserasset = sapiV3PostAssetGetUserAsset = Entry('asset/getUserAsset', 'sapiV3', 'POST', {'cost': 0.5})
    sapiv3_post_sub_account_transfer = sapiV3PostSubAccountTransfer = Entry('sub-account/transfer', 'sapiV3', 'POST', {'cost': 1})
