...
class ImplicitAPI:
    ...
    private_get_earn_subscriptions = privateGetEarnSubscriptions = Entry('earn/subscriptions/', 'private', 'GET', {'cost': 1})
    private_get_earn_transactions = privateGetEarnTransactions = Entry('earn/transactions/', 'private', 'GET', {'cost': 1})
    ...
    private_post_travel_rule_contacts = privatePostTravelRuleContacts = Entry('travel_rule/contacts/', 'private', 'POST', {'cost': 1})
    private_post_earn_subscribe = privatePostEarnSubscribe = Entry('earn/subscribe/', 'private', 'POST', {'cost': 1})
    private_post_earn_subscriptions_setting = privatePostEarnSubscriptionsSetting = Entry('earn/subscriptions/setting/', 'private', 'POST', {'cost': 1})
    private_post_earn_unsubscribe = privatePostEarnUnsubscribe = Entry('earn/unsubscribe', 'private', 'POST', {'cost': 1})
    private_post_wecan_withdrawal = privatePostWecanWithdrawal = Entry('wecan_withdrawal/', 'private', 'POST', {'cost': 1})
    private_post_wecan_address = privatePostWecanAddress = Entry('wecan_address/', 'private', 'POST', {'cost': 1})
    private_post_trac_withdrawal = privatePostTracWithdrawal = Entry('trac_withdrawal/', 'private', 'POST', {'cost': 1})
    private_post_trac_address = privatePostTracAddress = Entry('trac_address/', 'private', 'POST', {'cost': 1})
    private_post_eurcv_withdrawal = privatePostEurcvWithdrawal = Entry('eurcv_withdrawal/', 'private', 'POST', {'cost': 1})
