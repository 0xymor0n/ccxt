...
import hashlib
from ccxt_versions.v_4_3_18.base.types import Int, Market, OrderBook, Strings, Ticker, Trade
...
class coinbaseinternational(ccxt_versions.v_4_3_18.async_support.coinbaseinternational):
