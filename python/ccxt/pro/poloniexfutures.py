...
from ccxt_versions.v_4_3_18.async_support.base.ws.cache import ArrayCache, ArrayCacheBySymbolById
...
class poloniexfutures(ccxt_versions.v_4_3_18.async_support.poloniexfutures):
