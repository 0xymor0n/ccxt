...
import hashlib
from ccxt_versions.v_4_3_18.base.types import Balances, Int, Num, Order, OrderBook, OrderSide, OrderType, Str, Ticker, Trade, TradingFees
...
class bitvavo(ccxt_versions.v_4_3_18.async_support.bitvavo):
