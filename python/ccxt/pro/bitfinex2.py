...
import hashlib
from ccxt_versions.v_4_3_18.base.types import Balances, Int, Order, OrderBook, Str, Ticker, Trade
...
class bitfinex2(ccxt_versions.v_4_3_18.async_support.bitfinex2):
