...
import hashlib
from ccxt_versions.v_4_3_18.base.types import Balances, Int, Order, OrderBook, Position, Str, Strings, Ticker, Tickers, Trade
...
class bitget(ccxt_versions.v_4_3_18.async_support.bitget):
