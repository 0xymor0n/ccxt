...
from ccxt_versions.v_4_3_18.base.types import Balances, Int, Order, OrderBook, Str, Strings, Ticker, Tickers, Trade
...
class wazirx(ccxt_versions.v_4_3_18.async_support.wazirx):
