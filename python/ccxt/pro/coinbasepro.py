...
import hashlib
from ccxt_versions.v_4_3_18.base.types import Int, Order, OrderBook, Str, Strings, Ticker, Tickers, Trade
...
class coinbasepro(ccxt_versions.v_4_3_18.async_support.coinbasepro):
